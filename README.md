...
*JDCP-6_E.Orlov_HomeWork32*

### Задача №1. “Калькулятор” (обязательная) - выполнена в модуле Adapter.
**Описание**
...
### Задача №2. “Двоичный фасад” (необязательна к выполнению) - выполнена в модуле Facade.
